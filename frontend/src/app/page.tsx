export default function Home() {
  return (
    <main className="flex flex-1 flex-col items-center justify-center gap-4 px-8">
      <h1 className="font-display text-display font-semibold text-text">Wren</h1>
      ...
      <span className="rounded-full bg-accent-subtle px-4 py-1 text-footnote font-medium text-accent-active">
        scaffold - phase 0
      </span>
    </main>
  );
